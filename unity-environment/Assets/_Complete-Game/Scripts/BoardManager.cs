...
namespace Completed {
    ...
    public class BoardManager : MonoBehaviour {
        ...
        public int wall2 = 2;
        public int wall3 = 3;
        public int zombie1 = 4;
        public int zombie2 = 5;
        public int food = 6;
        public int soda = 7;
        public int player = 8;
        public int exit = 9;
        ...
        public List<float> fieldState = new List<float>();
        ...
        Vector3 RandomPosition() {
            ...
            int randomIndex = random.Next(0, gridPositions.Count);
        ...
        void LayoutObjectAtRandom(GameObject[] tileArray, int minimum, int maximum) {
            ...
            int objectCount = random.Next(minimum, maximum + 1);
            ...
            for (int i = 0; i < objectCount; i++) {
                ...
                GameObject tileChoice = tileArray[random.Next(0, tileArray.Length)];
        ...
        public void SetupScene(int level) {
            ...
            GameObject exit = Instantiate(exitTile, new Vector3(columns - 1, rows - 1, 0f), Quaternion.identity, boardHolder) as GameObject;
            exit.GetComponent<SpriteRenderer>().sortingOrder = 1;
