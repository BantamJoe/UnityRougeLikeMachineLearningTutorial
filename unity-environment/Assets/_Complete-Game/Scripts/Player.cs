...
namespace Completed {
    ...
    public class Player : MovingObject {
        ...
        private void Update() {
            ...
            //We get our input from Monster Carlo Support :D 
            if (!GameManager.instance.manualPlay) {
              ...
              {
                if (GameManager.instance.PPOPlay && transform.position.x == 7 && transform.position.y == 7) {
                    GameManager.instance.insteadOfLoadingNextLevel();
                    ...
                    if (!GameManager.instance.PPOPlay) {

                        GameManager.instance.AddReward(food);
            ...
            //Check if we have a non-zero value for horizontal or 
